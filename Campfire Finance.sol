...
/*
 * Campfire Finance
 * Join the Campfire and HOLD with us!
 * Holders will be rewarded while lonely sellers that leave will be rekt!
 * The burn rate reduces the longer we join each other near the campfire ;)
 * 
 * READ THIS CAREFULLY:
 ...
 * 
 * www.campfirefinance.club
 * t.me/campfirefinance
 */
...
contract CampFireFinance is Context, IBEP20, Ownable {
    ...
    uint256 public _maxWalletToken = 300 * 10**6 * 10**9; // Max Wallet: 200 Million (1.3%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "CampFireFinance";
